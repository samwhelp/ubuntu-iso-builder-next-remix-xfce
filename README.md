...
# ubuntu-iso-builder-next-remix-xfce
...
> [ubuntu-iso-builder-next-remix-xfce](https://samwhelp.github.io/ubuntu-iso-builder-next-remix-xfce)

| Project |
| ------- |
| [ubuntu-iso-builder-next-template](https://github.com/samwhelp/ubuntu-iso-builder-next-template) |
| `+` |
| [ubuntu-iso-builder-next-remix-xfce](https://github.com/samwhelp/ubuntu-iso-builder-next-remix-xfce) |
| `=` |
| [ubuntu-iso-builder-next-respin-xfce](https://github.com/samwhelp/ubuntu-iso-builder-next-respin-xfce) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-next-remix-xfce/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-next-remix-xfce/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-next-remix-xfce/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-next-remix-xfce](https://github.com/samwhelp/ubuntu-iso-builder-next-remix-xfce)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-next-remix-xfce.git
```


> change dir to `ubuntu-iso-builder-next-remix-xfce`

``` sh
cd ubuntu-iso-builder-next-remix-xfce
```
...
> change dir to `~/work/ubuntu-iso-builder-next-remix-xfce/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-next-remix-xfce/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-next-remix-xfce/iso-profile/dist`
